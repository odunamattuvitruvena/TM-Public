...
if __name__ == "__main__" :
    ...
    incoming_g_clear_handler = MessageHandler(
        g_clearme,
        filters=Filters.command(["renewme@MalavikaMohan_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    upload_document_handler = MessageHandler(
        upload_document_f,
        filters=Filters.command(["upload@MalavikaMohan_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    help_text_handler = MessageHandler(
        help_message_f,
        filters=Filters.command(["help@MalavikaMohan_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
