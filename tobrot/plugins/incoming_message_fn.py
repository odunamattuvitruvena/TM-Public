...
async def incoming_message_f(client, message):
    """/leech command"""
    i_m_sefg = await message.reply_text("𝗣𝗿𝗼𝗰𝗲𝘀𝘀𝗶𝗻𝗴", quote=True)
    is_zip = False
    is_unzip = False
    is_unrar = False
    is_untar = False
    ...
    if dl_url is not None:
        await i_m_sefg.edit_text("𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗶𝗻𝗴 𝗟𝗶𝗻𝗸𝘀")
        ...
        await i_m_sefg.edit_text("𝗧𝗿𝘆𝗶𝗻𝗴 𝟮 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱")
        ...
        await i_m_sefg.edit_text(
            "𝗗𝗼𝗻𝘁 𝗨𝘀𝗲 𝗘𝗺𝗽𝘁𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 𝗥𝗲𝗽𝗹𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝘁𝗼 𝗟𝗶𝗻𝗸𝘀  "
...
async def incoming_youtube_dl_f(client, message):
    ...
    if dl_url is not None:
        ...
        await i_m_sefg.edit_text(
            "𝗗𝗼𝗻𝘁 𝗨𝘀𝗲 𝗘𝗺𝗽𝘁𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝗥𝗲𝗽𝗹𝘆 𝘁𝗼 𝗬𝗼𝘂𝘁𝘂𝗯𝗲 𝗟𝗶𝗻𝗸𝘀  "
            f"<b>API Error</b>: {cf_name}"
        )
#playlist
async def g_yt_playlist(client, message):
    """ /pytdl command """
    #i_m_sefg = await message.reply_text("𝗣𝗿𝗼𝗰𝗲𝘀𝘀𝗶𝗻𝗴...𝘆𝗼𝘂 𝘀𝗵𝗼𝘂𝗹𝗱 𝘄𝗮𝗶𝘁🤗", quote=True)
    ...
    if 'youtube.com/playlist' in message.reply_to_message.text:
        i_m_sefg = await message.reply_text("𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗶𝗻𝗴...𝘆𝗼𝘂 𝘀𝗵𝗼𝘂𝗹𝗱 𝘄𝗮𝗶𝘁🤗", quote=True)
        await yt_playlist_downg(message.reply_to_message, i_m_sefg, G_DRIVE)
    
    else:
        await message.reply_text("𝗥𝗲𝗽𝗹𝘆 𝘁𝗼 𝘆𝗼𝘂𝘁𝘂𝗯𝗲 𝗽𝗹𝗮𝘆𝗹𝗶𝘀𝘁 𝗹𝗶𝗻𝗸 𝗼𝗻𝗹𝘆 🙄")
