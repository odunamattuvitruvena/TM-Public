...
def add_magnet(aria_instance, magnetic_link, c_file_name):
    ...
    try:
        ...
        return False, "𝗙𝗔𝗜𝗟𝗘𝗗 \n" + str(e) + " \n𝗣𝗹𝗲𝗮𝘀𝗲 𝗱𝗼 𝗻𝗼𝘁 𝘀𝗲𝗻𝗱 𝗦𝗟𝗢𝗪 𝗹𝗶𝗻𝗸𝘀. 𝗥𝗲𝗮𝗱 /help"
    else:
...
def add_torrent(aria_instance, torrent_file_path):
    if torrent_file_path is None:
        return False, "𝗙𝗔𝗜𝗟𝗘𝗗 \n" + str(e) + " \n𝗦𝗼𝗺𝗲𝘁𝗵𝗶𝗻𝗴 𝗪𝗿𝗼𝗻𝗴𝗶𝗻𝗴 𝘄𝗵𝗲𝗻 𝘁𝗿𝘆𝗶𝗻𝗴 𝘁𝗼 𝗮𝗱𝗱 <u>TORRENT</u> 𝗳𝗶𝗹𝗲"
    if os.path.exists(torrent_file_path):
        ...
        return False, "𝗙𝗔𝗜𝗟𝗘𝗗 \n𝗣𝗹𝗲𝗮𝘀𝗲 𝘁𝗿𝘆 𝗼𝘁𝗵𝗲𝗿 𝘀𝗼𝘂𝗿𝗰𝗲𝘀 𝘁𝗼 𝗴𝗲𝘁 𝘄𝗼𝗿𝗸𝗮𝗯𝗹𝗲 𝗹𝗶𝗻𝗸"
...
async def call_apropriate_function(
    ...
    try:
        ...
        for key_f_res_se in final_response:
            ...
            message_to_send += "\n"
        if message_to_send != "":
            mention_req_user = f"<a href='tg://user?id={user_id}'>𝗬𝗼𝘂𝗿 𝗥𝗲𝗾𝘂𝗲𝘀𝘁𝗲𝗱 𝗙𝗶𝗹𝗲𝘀</a>\n\n"
            message_to_send = mention_req_user + message_to_send
            message_to_send = message_to_send + "\n\n" + "#uploads"
        else:
            message_to_send = "<i>𝗙𝗔𝗜𝗟𝗘𝗗</i> 𝘁𝗼 𝘂𝗽𝗹𝗼𝗮𝗱 𝗳𝗶𝗹𝗲𝘀. 😞😞"
    ...
    try:
        ...
        if not complete:
            if not file.error_message:
                ...
                msg += f"\n<b>𝗦𝗽𝗲𝗲𝗱⚡️</b>: {file.download_speed_string()}"
                msg += f"\n<b>𝗦𝘁𝗮𝘁𝘂𝘀📊</b>: {file.progress_string()} <b>of</b> {file.total_length_string()} <b>|</b> {file.eta_string()} <b>|</b> {msgg}"
                ...
                inline_keyboard = []
                ikeyboard = []
                ikeyboard.append(InlineKeyboardButton("𝗦𝘁𝗼𝗽𝗽𝗲𝗱❌", callback_data=(f"cancel {gid}").encode("UTF-8")))
            ...
            await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
            await event.edit(f"𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗱 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆: `{file.name}`")
            return True
    except Exception as e:
        LOGGER.info(str(e))
        if " not found" in str(e) or "'file'" in str(e):
            await event.edit("𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗖𝗮𝗻𝗰𝗲𝗹𝗲𝗱")
            return False
        elif " depth exceeded" in str(e):
            file.remove(force=True)
            await event.edit("𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗔𝘂𝘁𝗼 𝗖𝗮𝗻𝗰𝗲𝗹𝗲𝗱\nYour Torrent/𝗟𝗶𝗻𝗸 𝗶𝘀 𝗗𝗲𝗮𝗱.")
            return False
        else:
            LOGGER.info(str(e))
