...
async def down_load_media_f(client, message):
    ...
    if message.reply_to_message is not None:
        ...
        the_real_download_location = await client.download_media(
            ...
            progress_args=(
                "𝗧𝗿𝘆𝗶𝗻𝗴 𝟮 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱", mess_age, c_time
            )
        )
        end_t = datetime.now()
        ...
        await mess_age.edit_text(f"𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗱 𝘁𝗼 <code>{the_real_download_location}</code> in <u>{ms}</u> 𝘀𝗲𝗰𝗼𝗻𝗱𝘀")
        ...
        await mess_age.edit_text("𝗥𝗲𝗽𝗹𝘆 𝘁𝗼 𝗮 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗠𝗲𝗱𝗶𝗮, 𝘁𝗼 𝘂𝗽𝗹𝗼𝗮𝗱 𝘁𝗼 𝘁𝗵𝗲 𝗖𝗹𝗼𝘂𝗱 𝗗𝗿𝗶𝘃𝗲.")
